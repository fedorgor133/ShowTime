...
public class ManagementLists {
    ...
    private Map<String, GrupInterest> llistaGrupInters;

    public ManagementLists(PortfolioPeople portfolioPeople, Map<String, Movie> llistaPelicules, Map<String, Series> llistaSeries, Map<String, GrupInterest> llistaGrupInters) {
    ...
    public String followGroup(String nomGrup, String usuari) {
        try {
            ...
            GrupInterest grup = llistaGrupInters.get(nomGrup);
            if (grup != null) {
    ...
    public String getAccessCode(String grup) {
        GrupInterest grupInterest = llistaGrupInters.get(grup);
        if (grupInterest != null) {
            return grupInterest.getAccessCode();
        } else {
            return Messages.GroupNotFound.getMessage();
        }
    }
