...
import ub.edu.model.Episode;
import ub.edu.resources.dao.Trio;
import ub.edu.resources.dao.entities.DAOEpisode;
...
public class DAOEpisodeMOCK implements DAOEpisode {
    ...
    private void addEpisodi(String nomSerie, int numTemporada, int numEpisodi, String titolEpisodi, int durada){
        episodis.put(new Trio<>(nomSerie, numTemporada, numEpisodi), new Episode(nomSerie, numTemporada, numEpisodi, titolEpisodi, durada));
    }
