...
public class GrupInterest {
    ...
    public GrupInterest(String groupName, String description, String accessCode) {
    ...
    public void addMembre(Person person, int i) {
    ...
    public String accesMembership(MemberStrategy strategy, GrupInterest grup, Person person) {
