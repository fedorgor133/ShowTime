Feature: 03c - List the movie catalog
  As a user/person,
  I want to list the available movies,
  In order to view the content of ShowTVTime by genre.

  # Acceptance Criteria US3a.3: List movies for a genre
