...
In response to the growing number of movies and TV series available, **SHOW-TV-Time** has been developed to help users track their viewing history and engage with communities of shared interests. The application is currently designed to be implemented in Catalan but is structured for easy adaptation to other languages.
